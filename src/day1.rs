...
pub fn day1_1(input: String) -> Result<i64, Error>{
...
pub fn day1_2(input: String) -> Result<i64, Error>{
    let turns = day1_parser(input)?;
...
fn day1_2_solver(turns: Vec<i64>) -> i64{
    ...
    for turn in turns{
        let crossings:i64 = if turn >= 0{
            ...
            (current_dial_position-1).div_euclid(100) - (current_dial_position + turn - 1).div_euclid(100)
        };
